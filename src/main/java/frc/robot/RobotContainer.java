...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                m_operatorController.a()
                                .onTrue(new SetElevatorPositionCommand(ElevatorConstants.kLevel1));
                m_operatorController.b()
                                .onTrue(new SetElevatorPositionCommand(ElevatorConstants.kLevel2));
                m_operatorController.y()
                                .onTrue(new SetElevatorPositionCommand(ElevatorConstants.kLevel3));
                m_operatorController.x().onTrue(new SetElevatorPositionCommand(
