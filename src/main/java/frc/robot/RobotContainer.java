...
import frc.robot.commands.teleop.SwerveCommands.StrafeLeft;
import frc.robot.commands.teleop.SwerveCommands.StrafeRight;
...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                m_driverController.leftTrigger(0.05).whileTrue(new StrafeLeft());
                m_driverController.rightTrigger(0.05).whileTrue(new StrafeRight());
