...
public class AlignToL1 extends Command {
  ...
  public void execute() {  
    ...
    var ySpeed = strafeController.calculate(aprilTagDistanceToRobot.getY());
    ...
    double rotationDifference = Math.abs(currentRobotPose.getRotation().getRadians() - targetAngle);
    ...
    // }
    RobotContainer.m_swerveSubsystem.alignRobotToAprilTag(targetAngle, getDriverControllerLeftY(), -ySpeed);
