...
public class CorrectCoralPositionCommand extends Command {
  ...
  public void initialize() {
    Robot.m_operatorController.setRumble(GenericHID.RumbleType.kBothRumble, 1);
  }

  // Called every time the scheduler runs while the command is scheduled.
  @Override
  public void execute() {
    if (!Robot.m_indexSubsystem.isShallowBeamBroken()) {
      Robot.m_indexSubsystem.setPower(-Constants.CoralIndexerConstants.kCorrectionPower);
    } else {
