...
public class ClimbSubsystem extends SubsystemBase {
    ...
    public ClimbSubsystem() {
        ...
        m_followerMotorConfig.smartCurrentLimit(ClimbConstants.kMotorStallCurrent, ClimbConstants.kMotorFreeSpeedCurrent);
        ...
        m_followerMotor.configure(m_followerMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    ...
    public void periodic() {
        ...
        if (!(Robot.isSimulation())) {
            ...
            SmartDashboard.putNumber("Climb Motor (" + ClimbConstants.kClimbLeaderMotorCANID + ") Current", m_leaderMotor.getOutputCurrent());
            SmartDashboard.putNumber("Climb Motor (" + ClimbConstants.kClimbFollowerMotorCANID + ") Current", m_leaderMotor.getOutputCurrent());
